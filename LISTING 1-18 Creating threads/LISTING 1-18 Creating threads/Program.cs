    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Foreground vs Background:
                ...
                • The operating system will run a foreground process to completion, which means that an application 
                  will not terminate while it contains an active foreground thread.
                • A foreground process that contains an infinite loop will execute forever, or until it throws an 
                  uncaught exception or when the operating system terminates it.
                • Tasks are created as background processes.
                • Tasks can be terminated before they complete if all the foreground threads in an application 
                  complete.
